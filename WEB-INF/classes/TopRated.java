...
import java.util.*;
import pojo.BestService;
import pojo.BestProfessional;
...
public class TopRated extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		bestServices  = MongoDBDataStoreUtilities.topRatedServices();
		bestProfessionals  = MongoDBDataStoreUtilities.topRatedProfessionals();
		
		String name = "Trending";
		
		request.setAttribute("bestServices",bestServices);
		request.setAttribute("bestProfessionals",bestProfessionals);
